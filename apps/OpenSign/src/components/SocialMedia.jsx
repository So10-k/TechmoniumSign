    ...
    <React.Fragment>
      ...
      >
        ...
        <span className="fa-sr-only">
          techmoniumsign’s {t("social-media.github")}
        </span>
      </NavLink>
      <NavLink
      ...
      >
        ...
        <span className="fa-sr-only">
          techmoniumsign’s {t("social-media.linked-in")}
        </span>
      </NavLink>
      <NavLink
      ...
      >
        ...
        <span className="fa-sr-only">
          techmoniumsign’s {t("social-media.twitter")}
        </span>
      </NavLink>
      <NavLink
      ...
      >
        ...
        <span className="fa-sr-only">
          techmoniumsign’s {t("social-media.discord")}
        </span>
      </NavLink>
    </React.Fragment>
  );

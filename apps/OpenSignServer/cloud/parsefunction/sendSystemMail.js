...
async function sendMailProvider(req) {
  ...
  const reportMsg = `<p style="font-size: 13px; color:grey; text-align: center;">If you think this email is inappropriate or spam, you may file a complaint with Techmonium Sign <a href="mailto:complaints@sam.ottens.org?subject=Spam%20report%20for%20user%20ID%20${extUserId}">here</a>.</p>`;
